...
public class PauseScript : MonoBehaviour
{
    ...
    //public AudioSource gameMusic; //I wanted to use this, but I can't add audioSource in the inspector, I can't call method from AudioSource class also. Maybe there's a bug...
